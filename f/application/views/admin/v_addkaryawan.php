  ...
  <section class="content">
    ...
    <div class="col-md-14">
      ...
      <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url('admin/simpankaryawan/') ?>" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="telp" class="form-control" id="inputPassword3" placeholder="telp" required="">
              </div>
            </div>
            </div>
          </div>

              ...
              <tbody>
                ...
                foreach($data as $c){ 
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <a type="button" href="<?php echo base_url(). 'admin/v_edit/'. $c->nik; ?>" class="btn bg-blue smallbtn"><i class="fa fa-fw fa-edit"></i></a>
                      <a type="button" href="<?php echo base_url(). 'admin/del_k/'. $c->nik; ?>" class="btn bg-red smallbtn"><i class="fa fa-fw fa-close"></i></a>
                    </td>
